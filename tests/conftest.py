...
import pytest
from navability.entities.NavAbilityClient import NavAbilityHttpsClient, NavAbilityWebsocketClient, NavAbilityClient
...
def navability_wss_client(env_config) -> NavAbilityClient:
    return NavAbilityWebsocketClient(url=env_config["navability_client"]["url_websocket"])
